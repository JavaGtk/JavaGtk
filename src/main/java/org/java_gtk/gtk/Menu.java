...
/**
 * Menu is a MenuShell that implements a drop down menu consisting of a 
 * list of MenuItem objects which can be navigated and activated by the 
